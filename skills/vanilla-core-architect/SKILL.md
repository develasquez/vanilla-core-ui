...
- **[Project Boilerplate Kit](references/boilerplate.md)** (`package.json`, `server.js`, `index.html`, `style.css`)
- **[Core Module Blueprints](references/blueprints.md)** (`store.js`, `dom-elements.js`, `ui/renderer.js`, `load.js`, `main.js`)
- **[Component Pattern Blueprint](references/component.md)** (`header.html`, `header.js`)
- **[Gemini Models Reference](references/gemini-models.md)** (Model selection guidance)
